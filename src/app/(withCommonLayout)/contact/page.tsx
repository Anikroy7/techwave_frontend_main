...
export default function contactPage() {
  return (
    <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto b rounded-lg shadow-lg">
      ...
      <div className="">
        ...
        <div className="mt-8">
          ...
          <textarea className="w-full h-32  mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" />
        </div>
        <div className="mt-8">
          <Button

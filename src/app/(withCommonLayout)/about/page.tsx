    ...
    <div className="container mx-auto py-10">
      <div className="mb-10">
        ...
        <p className="text-center text-lg max-w-2xl mx-auto">
          ...
          innovative technology solutions that enhance productivity and foster
          collaboration.
        </p>
      </div>
      ...
      <div className="mb-10">
        ...
        <p className="text-center text-lg max-w-2xl mx-auto">
          We envision a world where technology bridges gaps, connects
          communities, and creates endless possibilities for growth and
          development.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className=" shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105">
          ...
          <p className="text-center mt-2">
            John has over 10 years of experience in the tech industry and is
        ...
        <div className=" shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105">
          ...
          <p className="text-center mt-2">
            Jane leads our technical team with a focus on developing
        ...
        <div className=" shadow-lg rounded-lg p-4 transition-transform transform hover:scale-105">
          ...
          <p className="text-center mt-2">
            Emily is responsible for crafting our brand message and engaging our
            community.
          </p>
        </div>
      </div>
